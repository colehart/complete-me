...
export default class Trie {
  ...
  addMatches(currMatches, currLetter, currNode) {
    ...
    matches.push(this.runLetterTrace(currLetter, currNode));
  ...
  runLetterTrace(currLetter, currNode) {
    ...
    if (currentNode.children[currentLetter].endOf) {
      return currentNode.children[currentLetter].endOf;
    }

    while (!currentNode.children[currentLetter].endOf) {
      currentNode = currentNode.children[currentLetter];

      this.runLetterTrace(currentLetter, currentNode);
    }
  }
